...
//------------------------------------------------------------------------------
// GetConfInt64 возвращает значение из конфигурации, если оно присутсвует
//               иначе возвращате default_value
func (Conf *Config) GetConfInt64(name string, default_value int64) int64{
	temp_str, ok := Conf.Configuration[name]
